...
function Home() {
  ...
  return (
    <div className="main-container">        
      <h2 className="UpcomingMeetings" >Upcoming Meetings </h2>
      <div className="Card-Container" >

        {
        //Rendring all the upcoming meetings.
        meetings.filter( (singleMeeting)=>{
              let today = new Date();
        ...
        .map( (singleMeeting)=>{
          ...
          let meetingTime = date.toLocaleTimeString('en', {hour :"2-digit", minute:"2-digit"});
          let FinalTime = meetingTime+ " " + fDate;
          let MeetingImg = "https://source.unsplash.com/1600x800/?"+ singleMeeting.Img ;

          return <MeetingCard title={singleMeeting.Title} img={MeetingImg} desc={singleMeeting.Desc} time={FinalTime} />
          } )
        }
      </div>
    </div>
